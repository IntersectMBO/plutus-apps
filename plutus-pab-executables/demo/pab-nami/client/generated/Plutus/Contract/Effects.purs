...
_MintingPolicyHashResponse =
  prism' MintingPolicyHashResponse case _ of
...
derive instance genericWriteBalancedTxResponse :: Generic WriteBalancedTxResponse _

--------------------------------------------------------------------------------
_WriteBalancedTxFailed :: Prism' WriteBalancedTxResponse WalletAPIError
_WriteBalancedTxFailed =
  prism' WriteBalancedTxFailed case _ of
    (WriteBalancedTxFailed a) -> Just a
    _ -> Nothing

_WriteBalancedTxSuccess :: Prism' WriteBalancedTxResponse (Either RawJson Tx)
_WriteBalancedTxSuccess =
  prism' WriteBalancedTxSuccess case _ of
