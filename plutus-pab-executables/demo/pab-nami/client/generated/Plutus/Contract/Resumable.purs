...
--------------------------------------------------------------------------------
newtype Responses a
  = Responses { unResponses :: Map (Tuple IterationID RequestID) a }

derive instance eqResponses :: (Eq a) => Eq (Responses a)

instance showResponses :: (Show a) => Show (Responses a) where
  show a = genericShow a

instance encodeJsonResponses :: (EncodeJson a) => EncodeJson (Responses a) where
  encodeJson =
    defer \_ ->
      E.encode $ unwrap
        >$< ( E.record
...
instance decodeJsonResponses :: (DecodeJson a) => DecodeJson (Responses a) where
...
derive instance genericResponses :: Generic (Responses a) _

derive instance newtypeResponses :: Newtype (Responses a) _
