...
instance encodeJsonContractReport :: (EncodeJson a) => EncodeJson (ContractReport a) where
  encodeJson =
    defer \_ ->
      E.encode $ unwrap
        >$< ( E.record
...
instance decodeJsonContractReport :: (DecodeJson a) => DecodeJson (ContractReport a) where
  decodeJson =
    defer \_ ->
      D.decode
        $ ( ContractReport
...
--------------------------------------------------------------------------------
newtype ContractSignatureResponse a
  = ContractSignatureResponse
  { csrDefinition :: a
  , csrSchemas :: Array (FunctionSchema FormSchema)
  }

derive instance eqContractSignatureResponse :: (Eq a) => Eq (ContractSignatureResponse a)

instance showContractSignatureResponse :: (Show a) => Show (ContractSignatureResponse a) where
  show a = genericShow a

instance encodeJsonContractSignatureResponse :: (EncodeJson a) => EncodeJson (ContractSignatureResponse a) where
  encodeJson =
    defer \_ ->
      E.encode $ unwrap
        >$< ( E.record
...
instance decodeJsonContractSignatureResponse :: (DecodeJson a) => DecodeJson (ContractSignatureResponse a) where
  decodeJson =
    defer \_ ->
      D.decode
        $ ( ContractSignatureResponse
...
derive instance newtypeContractSignatureResponse :: Newtype (ContractSignatureResponse a) _
...
--------------------------------------------------------------------------------
newtype ContractActivationArgs a
  = ContractActivationArgs
  { caID :: a
  , caWallet :: Maybe Wallet
  }

derive instance eqContractActivationArgs :: (Eq a) => Eq (ContractActivationArgs a)

instance showContractActivationArgs :: (Show a) => Show (ContractActivationArgs a) where
  show a = genericShow a

instance encodeJsonContractActivationArgs :: (EncodeJson a) => EncodeJson (ContractActivationArgs a) where
  encodeJson =
    defer \_ ->
      E.encode $ unwrap
        >$< ( E.record
...
instance decodeJsonContractActivationArgs :: (DecodeJson a) => DecodeJson (ContractActivationArgs a) where
  decodeJson =
    defer \_ ->
      D.decode
        $ ( ContractActivationArgs
...
derive instance newtypeContractActivationArgs :: Newtype (ContractActivationArgs a) _
...
--------------------------------------------------------------------------------
newtype ContractInstanceClientState a
...
instance showContractInstanceClientState :: (Show a) => Show (ContractInstanceClientState a) where
  show a = genericShow a

instance encodeJsonContractInstanceClientState :: (EncodeJson a) => EncodeJson (ContractInstanceClientState a) where
  encodeJson =
    defer \_ ->
      E.encode $ unwrap
        >$< ( E.record
...
instance decodeJsonContractInstanceClientState :: (DecodeJson a) => DecodeJson (ContractInstanceClientState a) where
  decodeJson =
    defer \_ ->
      D.decode
        $ ( ContractInstanceClientState
...
derive instance newtypeContractInstanceClientState :: Newtype (ContractInstanceClientState a) _
...
instance encodeJsonCombinedWSStreamToClient :: EncodeJson CombinedWSStreamToClient where
  encodeJson =
    defer \_ -> case _ of
...
instance decodeJsonCombinedWSStreamToClient :: DecodeJson CombinedWSStreamToClient where
  decodeJson =
    defer \_ ->
      D.decode
...
instance encodeJsonCombinedWSStreamToServer :: EncodeJson CombinedWSStreamToServer where
  encodeJson =
    defer \_ -> case _ of
...
instance decodeJsonCombinedWSStreamToServer :: DecodeJson CombinedWSStreamToServer where
  decodeJson =
    defer \_ ->
      D.decode
