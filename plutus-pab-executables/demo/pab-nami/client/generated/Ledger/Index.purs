...
newtype UtxoIndex
  = UtxoIndex { getIndex :: Map TxOutRef TxOut }
...
_InOutTypeMismatch =
  prism' (\{ a, b } -> (InOutTypeMismatch a b)) case _ of
...
_Phase1 =
  prism' (const Phase1) case _ of
    Phase1 -> Just unit
    _ -> Nothing

_Phase2 :: Prism' ValidationPhase Unit
_Phase2 =
  prism' (const Phase2) case _ of
    Phase2 -> Just unit
    _ -> Nothing
...
_ValidatorScript =
  prism' (\{ a, b } -> (ValidatorScript a b)) case _ of
    (ValidatorScript a b) -> Just { a, b }
    _ -> Nothing

_MintingPolicyScript :: Prism' ScriptType MintingPolicy
_MintingPolicyScript =
  prism' MintingPolicyScript case _ of
