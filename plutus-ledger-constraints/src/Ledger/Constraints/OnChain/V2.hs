...
{-# INLINABLE checkV2ScriptContext #-}
-- | Does the 'ScriptContext' satisfy the constraints?
checkV2ScriptContext :: forall i o. ToData o => TxConstraints i o -> ScriptContext -> Bool
checkV2ScriptContext TxConstraints{txConstraints, txConstraintFuns = TxConstraintFuns txCnsFuns, txOwnInputs, txOwnOutputs} ptx =
    traceIfFalse "Ld" -- "checkV2ScriptContext failed"
