...
Full examples of Plutus Applications can be found in the ``plutus`` `repository <https://github.com/input-output-hk/plutus-apps/tree/master/plutus-use-cases>`_.
