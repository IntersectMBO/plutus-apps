...
import Plutus.V1.Ledger.Api.Api (Datum (Datum), DatumHash, ValidatorHash)
import Plutus.V1.Ledger.Api.Contexts (ScriptContext (ScriptContext, scriptContextTxInfo), TxInfo (txInfoValidRange))
