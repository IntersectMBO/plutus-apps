...
[NOTE]
====
You may also want to consult the https://plutus-community.readthedocs.io/en/latest/[Plutus community documentation] for specific details regarding your particular environment, especially if you are a MacOS user.
====
...
We advise users to also consult the environment specific instructions for setting Plutus up through Nix in the https://plutus-community.readthedocs.io/en/latest/[Plutus community documentation]. At a minimum, you will need to set up the cache:
