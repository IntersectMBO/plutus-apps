...
instance DecodeJson Tx where
  decodeJson = defer \_ -> D.decode $ (Tx <$> D.record "Tx"
...
instance DecodeJson TxIn where
  decodeJson = defer \_ -> D.decode $ (TxIn <$> D.record "TxIn"
...
instance DecodeJson TxInType where
  decodeJson = defer \_ -> D.decode
    $ D.sumType "TxInType" $ Map.fromFoldable
...
instance DecodeJson TxOutTx where
  decodeJson = defer \_ -> D.decode $ (TxOutTx <$> D.record "TxOutTx"
