...
tests = do
  testGroup "pagination"
    [ testGroup "pageOf"
        [ testPropertyNamed "size of pageItems of all pages should be less or equal than total number of items in list"
                            "pageItemsSizeLessOrEqualGenItemsSizeSpec"
                            pageItemsSizeLessOrEqualGenItemsSizeSpec
        , testPropertyNamed "size of pageItems of all pages should be less or equal than requested page size"
        ...
        , testPropertyNamed "page items should be sorted in ascending order"
                            ...
                            pageItemsSortedAscOrderSpec
        , testPropertyNamed "page size equal to total number of items in list should return a single page"
