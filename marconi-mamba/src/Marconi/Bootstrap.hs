...
import Cardano.Api (AsType (AsShelleyAddress), ChainPoint (ChainPointAtGenesis), deserialiseFromBech32, toAddressAny)
...
targetAddressParser =
    ...
    . words
    where
        deserializeToCardano = fmap toAddressAny . deserialiseFromBech32 AsShelleyAddress
