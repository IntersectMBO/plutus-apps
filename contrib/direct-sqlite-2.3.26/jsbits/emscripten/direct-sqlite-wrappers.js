...
function h$direct_sqlite_md5_init(ctx_d, ctx_o) {
  h$logWrapper("h$direct_sqlite_md5_init");
  var ctx_ptr = h$getTmpBuffer(0, h$md5_ctx_size);
  h$direct_sqlite._cryptonite_md5_init(ctx_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$md5_ctx_size);
}

function h$direct_sqlite_md5_update(ctx_d, ctx_o, data_d, data_o, len) {
  h$logWrapper("h$direct_sqlite_md5_update");
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d,  ctx_o,  h$md5_ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  h$direct_sqlite._cryptonite_md5_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$md5_ctx_size);
}

function h$direct_sqlite_md5_finalize(ctx_d, ctx_o, out_d, out_o) {
  h$logWrapper("h$direct_sqlite_md5_finalize");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$md5_ctx_size),
      out_ptr = h$getTmpBuffer(1, h$md5_digest_size);
  h$direct_sqlite._cryptonite_md5_finalize(ctx_ptr, out_ptr);
...
function h$direct_sqlite_sha256_init(ctx_d, ctx_o) {
  h$logWrapper("h$direct_sqlite_sha256_init");
  var ctx_ptr = h$getTmpBuffer(0, h$sha256_ctx_size);
  h$direct_sqlite._cryptonite_sha256_init(ctx_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha256_ctx_size);
}

function h$direct_sqlite_sha256_update(ctx_d, ctx_o, data_d, data_o, len) {
  h$logWrapper("h$direct_sqlite_sha256_update");
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d,  ctx_o,  h$sha256_ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  h$direct_sqlite._cryptonite_sha256_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha256_ctx_size);
}

function h$direct_sqlite_sha256_finalize(ctx_d, ctx_o, out_d, out_o) {
  h$logWrapper("h$direct_sqlite_sha256_finalize");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$sha256_ctx_size),
      out_ptr = h$getTmpBuffer(1, h$sha256_digest_size);
  h$direct_sqlite._cryptonite_sha256_finalize(ctx_ptr, out_ptr);
...
function h$direct_sqlite_sha512_init(ctx_d, ctx_o) {
  h$logWrapper("h$direct_sqlite_sha512_init");
  var ctx_ptr = h$getTmpBuffer(0, h$sha512_ctx_size);
  h$direct_sqlite._cryptonite_sha512_init(ctx_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha512_ctx_size);
}

function h$direct_sqlite_sha512_update(ctx_d, ctx_o, data_d, data_o, len) {
  h$logWrapper("h$direct_sqlite_sha512_update");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$sha512_ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  h$direct_sqlite._cryptonite_sha512_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha512_ctx_size);
}

function h$direct_sqlite_sha512_finalize(ctx_d, ctx_o, out_d, out_o) {
  h$logWrapper("h$direct_sqlite_sha512_finalize");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$sha512_ctx_size),
      out_ptr = h$getTmpBuffer(1, h$sha512_digest_size);
  h$direct_sqlite._cryptonite_sha512_finalize(ctx_ptr, out_ptr);
...
function h$direct_sqlite_sha3_init(ctx_d, ctx_o, hashlen) {
  h$logWrapper("h$direct_sqlite_sha3_init");
  var ctx_size = Math.min(h$sha3_ctx_size_max, ctx_d.len-ctx_o);
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d, ctx_o, ctx_size);
  h$direct_sqlite._cryptonite_sha3_init(ctx_ptr, hashlen);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
}

function h$direct_sqlite_sha3_update(ctx_d, ctx_o, data_d, data_o, len) {
  h$logWrapper("h$direct_sqlite_sha3_update");
  var ctx_size = Math.min(h$sha3_ctx_size_max, ctx_d.len-ctx_o);
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  h$direct_sqlite._cryptonite_sha3_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
}

function h$direct_sqlite_sha3_finalize(ctx_d, ctx_o, hashlen, out_d, out_o) {
  h$logWrapper("h$direct_sqlite_sha3_finalize");
  var ctx_size = Math.min(h$sha3_ctx_size_max, ctx_d.len-ctx_o);
     //  digest_size = Math.min(h$sha3_digest_size_max,out_d.len-out_o);
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, ctx_size),
      out_ptr = h$getTmpBufferWith(1, out_d, out_o, hashlen / 8);
  h$direct_sqlite._cryptonite_sha3_finalize(ctx_ptr, hashlen, out_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
...
function h$direct_sqlite_blake2b_init(ctx_d, ctx_o, hashlen) {
  h$logWrapper("h$direct_sqlite_blake2b_init");
  var ctx_ptr = h$getTmpBuffer(0, ctx_d, ctx_o, h$blake2b_state_size);
  h$direct_sqlite._cryptonite_blake2b_init(ctx_ptr, hashlen);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$blake2b_state_size);
}

function h$direct_sqlite_blake2b_update(ctx_d, ctx_o, data_d, data_o, len) {
  h$logWrapper("h$direct_sqlite_blake2b_update");
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d, ctx_o, h$blake2b_state_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  h$direct_sqlite._cryptonite_blake2b_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$blake2b_state_size);
}

function h$direct_sqlite_blake2b_finalize(ctx_d, ctx_o, hashlen, out_d, out_o) {
  h$logWrapper("h$direct_sqlite_blake2b_finalize");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$blake2b_state_size),
      out_ptr = h$getTmpBuffer(1, hashlen);
  h$direct_sqlite._cryptonite_blake2b_finalize(ctx_ptr, hashlen, out_ptr);
...
function h$direct_sqlite_ed25519_point_base_scalarmul(r_d, r_o, s_d, s_o) {
  ...
  h$direct_sqlite._cryptonite_ed25519_point_base_scalarmul(r_ptr, s_ptr);
  h$copyFromHeap(r_ptr, r_d, r_o, 160);
}

function h$direct_sqlite_ed25519_point_encode(out_d, out_o, in_d, in_o) {
    // XXX sizes
    ...
    h$direct_sqlite._cryptonite_ed25519_point_encode(out_ptr, in_ptr);
    h$copyFromHeap(out_ptr, out_d, out_o, 32);
}

function h$direct_sqlite_ed25519_scalar_decode_long(out_d, out_o, in_d, in_o, len) {
  ...
  var r = h$direct_sqlite._cryptonite_ed25519_scalar_decode_long(out_ptr, in_ptr, len);
  h$copyFromHeap(out_ptr, out_d, out_o, 40);
  return r;
}

function h$direct_sqlite_ed25519_sign_open(m_d, m_o, mlen, pk_d, pk_o, sig_d, sig_o) {
  h$logWrapper("h$direct_sqlite_ed25519_sign_open");
  ...
  return h$direct_sqlite._cryptonite_ed25519_sign_open(m_ptr, mlen, pk_ptr, sig_ptr);
}

function h$direct_sqlite_ed25519_sign(m_d, m_o, mlen, salt_d, salt_o, slen, sk_d, sk_o, pk_d, pk_o, sig_d, sig_o) {
  h$logWrapper("h$direct_sqlite_ed25519_sign");
  var m_ptr    = h$getTmpBufferWith(0, m_d, m_o, mlen),
  ...
  h$direct_sqlite._cryptonite_ed25519_sign
             (m_ptr, mlen, salt_ptr, slen, sk_ptr, pk_ptr, sig_ptr);
  h$copyFromHeap(sig_ptr, sig_d, sig_o, h$ed25519_sig_size);
}

function h$direct_sqlite_ed25519_publickey(sk_d, sk_o, pk_d, pk_o) {
  h$logWrapper("h$direct_sqlite_ed25519_publickey");
  var sk_ptr = h$getTmpBufferWith(0, sk_d, sk_o, h$ed25519_sk_size),
      pk_ptr = h$getTmpBuffer(1, h$ed25519_pk_size);
  h$direct_sqlite._cryptonite_ed25519_publickey(sk_ptr, pk_ptr);
  h$copyFromHeap(pk_ptr, pk_d, pk_o, h$ed25519_pk_size);
}

function h$direct_sqlite_ed25519_point_add(pk1_d, pk1_o, pk2_d, pk2_o, res_d, res_o) {
  h$logWrapper("h$direct_sqlite_ed25519_point_add");
  ...
  var r = h$direct_sqlite._cryptonite_ed25519_point_add(pk1_ptr, pk2_ptr, res_ptr);
...
function h$direct_sqlite_fastpbkdf2_hmac_sha512( pw_d, pw_o, pw_len
                                            , salt_d, salt_o, salt_len
                                            , iterations
                                            , out_d, out_o, out_len) {
  h$logWrapper("h$direct_sqlite_fastpbkdf2_hmac_sha512");
  ...
  h$direct_sqlite._cryptonite_fastpbkdf2_hmac_sha512(pw_ptr, pw_len, salt_ptr, salt_len, iterations, out_ptr, out_len);
...
function h$wallet_encrypted_derive_public( pub_in_d, pub_in_o
  ...
  var r = h$direct_sqlite._wallet_encrypted_derive_public(pub_in_ptr, cc_in_ptr, index, pub_out_ptr, cc_out_ptr, mode);
...
function h$wallet_encrypted_derive_private( in_d, in_o,
  ...
  h$direct_sqlite._wallet_encrypted_derive_private(in_ptr, pass_ptr, pass_len, index, out_ptr, mode);
...
function h$wallet_encrypted_sign( encrypted_key_d, encrypted_key_o
  ...
  h$direct_sqlite._wallet_encrypted_sign(ec_ptr, pass_ptr, pass_len, data_ptr, data_len, sig_ptr);
  h$copyFromHeap(sig_ptr, sig_d, sig_o, h$ed25519_sig_size);
}
...
function h$wallet_encrypted_from_secret( pass_d, pass_o, pass_len
  ...
  var r = h$direct_sqlite._wallet_encrypted_from_secret(pass_ptr, pass_len, seed_ptr, cc_ptr, ec_ptr);
...
function h$wallet_encrypted_change_pass( in_d, in_o
  ...
  h$direct_sqlite._wallet_encrypted_change_pass(in_ptr, old_pass_ptr, old_pass_len, new_pass_ptr, new_pass_len, out_ptr);
  h$copyFromHeap(out_ptr, out_d, out_o, h$full_key_size);
}
...
function h$wallet_encrypted_new_from_mkg( pass_d, pass_o, pass_len
  ...
  var r = h$direct_sqlite._wallet_encrypted_new_from_mkg(pass_ptr, pass_len, master_ptr, encrypted_ptr);
...
function h$direct_sqlite_chacha_generate(dst_d, dst_o, ctx_d, ctx_o, bytes) {
  h$logWrapper("h$direct_sqlite_chacha_generate");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$chacha_ctx_size),
      dst_ptr = h$getTmpBuffer(1, bytes);
  h$direct_sqlite._cryptonite_chacha_generate(dst_ptr, ctx_ptr, bytes);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$chacha_ctx_size);
  h$copyFromHeap(dst_ptr, dst_d, dst_o, bytes);
}

function h$direct_sqlite_chacha_combine(dst_d, dst_o, ctx_d, ctx_o, src_d, src_o, bytes) {
  h$logWrapper("h$direct_sqlite_chacha_generate");
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$chacha_ctx_size),
      src_ptr = h$getTmpBufferWith(1, src_d, src_o, bytes),
      dst_ptr = h$getTmpBuffer(2, bytes);
  h$direct_sqlite._cryptonite_chacha_combine(dst_ptr, ctx_ptr, src_ptr, bytes);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$chacha_ctx_size);
  h$copyFromHeap(dst_ptr, dst_d, dst_o, bytes);
}

function h$direct_sqlite_chacha_init( ctx_d, ctx_o, nb_rounds, keylen, key_d, key_o, ivlen, iv_d, iv_o) {
  ...
  h$direct_sqlite._cryptonite_chacha_init(ctx_ptr, nb_rounds, keylen, key_ptr, ivlen, iv_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$chacha_ctx_size);
}

function h$direct_sqlite_chacha_init_core( st_d, st_o, keylen, key_d, key_o, ivlen, iv_d, iv_o) {
  var key_ptr = h$getTmpBufferWith(0, key_d, key_o, keylen),
      iv_ptr  = h$getTmpBufferWith(1, iv_d, iv_o, ivlen),
      st_ptr = h$getTmpBuffer(2, h$chacha_state_size);
  h$direct_sqlite._cryptonite_chacha_init_core(st_ptr, keylen, key_ptr, ivlen, iv_ptr);
...
function h$direct_sqlite_poly1305_init(ctx_d, ctx_o, key_d, key_o) {
  var ctx_ptr  = h$getTmpBuffer(0, h$poly1305_ctx_size),
      key_ptr  = h$getTmpBufferWith(1, key_d, key_o, h$poly1305_key_size);
  h$direct_sqlite._cryptonite_poly1305_init(ctx_ptr, key_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$poly1305_ctx_size);
}

function h$direct_sqlite_poly1305_update(ctx_d, ctx_o, data_d, data_o, length) {
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d, ctx_o, h$poly1305_ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, length >>> 0);
  h$direct_sqlite._cryptonite_poly1305_update(ctx_ptr, data_ptr, length);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$poly1305_ctx_size);
}

function h$direct_sqlite_poly1305_finalize(mac8_d, mac8_o, ctx_d, ctx_o) {
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d, ctx_o, h$poly1305_ctx_size),
      mac8_ptr = h$getTmpBuffer(1, h$poly1305_mac_size);
  h$direct_sqlite._cryptonite_poly1305_finalize(mac8_ptr, ctx_ptr);
