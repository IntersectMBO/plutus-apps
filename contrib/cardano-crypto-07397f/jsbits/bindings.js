...
// EMCC:EXPORTED_FUNCTIONS _cardano_crypto_ed25519_sign_open _cardano_crypto_ed25519_sign _cardano_crypto_ed25519_publickey
// EMCC:EXPORTED_FUNCTIONS _cardano_crypto_ed25519_point_add
// EMCC:EXPORTED_FUNCTIONS _wallet_encrypted_derive_public _wallet_encrypted_derive_private _wallet_encrypted_derive_public
// EMCC:EXPORTED_FUNCTIONS _wallet_encrypted_sign _wallet_encrypted_from_secret _wallet_encrypted_change_pass
// EMCC:EXPORTED_FUNCTIONS _wallet_encrypted_new_from_mkg
...
function h$cardano_crypto_ed25519_sign_open(m_d, m_o, mlen, pk_d, pk_o, sig_d, sig_o) {
  ...
  return _cardano_crypto_ed25519_sign_open(m_ptr, mlen, pk_ptr, sig_ptr);
}
...
function h$cardano_crypto_ed25519_publickey(sk_d, sk_o, pk_d, pk_o) {
  ...
  _cardano_crypto_ed25519_publickey(sk_ptr, pk_ptr);
...
function h$cardano_crypto_ed25519_point_add(pk1_d, pk1_o, pk2_d, pk2_o, res_d, res_o) {
  ...
  var r = _cardano_crypto_ed25519_point_add(pk1_ptr, pk2_ptr, res_ptr);
