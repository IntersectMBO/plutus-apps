...
tests = testGroup "uniswap" [
    checkPredicateOptions (defaultCheckOptions & (increaseTransactionLimits . increaseTransactionLimits . increaseTransactionLimits)) "can create a liquidity pool and add liquidity"
