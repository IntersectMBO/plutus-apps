...
module Test.Marconi.Index.ScriptTx ( tests) where
...
import Gen.Marconi.Types (genTxBodyWithTxIns, genWitnessAndHashInEra)

import Marconi.Index.ScriptTx qualified as ScriptTx

tests :: TestTree
tests = testGroup "Marconi.ScriptTx.Indxers.Specs are:"
  [ testPropertyNamed
