...
let
  ...
  horrible-env-vars-hack = pkgs.runCommand "exfiltrate-env-vars"
    {
      inherit (project.shell) buildInputs nativeBuildInputs propagatedBuildInputs;
    }
    ''
  ...
  haskell-toolchain = iogx.modules.haskell.internal.makeToolchainForGhc project.meta.haskellCompiler;
